...
import './actions/ollamaActions.js';
...
import { ChatTeardownContribution } from './chatSetup/chatSetupContributions.js';
...
import { IOllamaLanguageModelsService, OllamaLanguageModelsService } from './ollamaLanguageModels.js';
import { OllamaDefaultAgentContribution } from './ollamaDefaultAgent.js';
...
// Disabled ChatSetupContribution to skip sign-in requirement for Ollama usage
...
// Ollama: OllamaDefaultAgentContribution triggers OllamaLanguageModelsService instantiation via injection
registerWorkbenchContribution2(OllamaDefaultAgentContribution.ID, OllamaDefaultAgentContribution, WorkbenchPhase.AfterRestored);
...
registerSingleton(IOllamaLanguageModelsService, OllamaLanguageModelsService, InstantiationType.Eager);
